...
type AnalysisResult = {
  ...
  examples?: { example_number: string; summary: string; outcome: string; page: number | null }[];
  warnings?: string[];
};
    ...
    <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <View style={styles.aiCard}>
        ...
        {analysisRun?.executive_summary && <View style={styles.aiReport}>
          ...
          <AiSection label="YÖNETİCİ ÖZETİ" text={analysisRun.executive_summary} /><AiSection label="TEKNİK PROBLEM" text={analysisRun.technical_problem} /><AiSection label="ÖNERİLEN ÇÖZÜM" text={analysisRun.proposed_solution} />
          ...
          {analysis?.examples?.length ? <AiList label="DENEYLER VE ÖRNEKLER" values={analysis.examples.map((example) => `${example.example_number}: ${example.summary} — ${example.outcome}${example.page ? ` · PDF s. ${example.page}` : ''}`)} /> : null}
